// features/factory/FactoryCalendarPage.tsx
// หน้าปฏิทินสำหรับโรงงาน
...
interface FactoryCalendarPageProps {
  schedule: Booking[];
  onUpdateSchedule: (schedule: Booking[]) => void;
}

const FactoryCalendarPage: React.FC<FactoryCalendarPageProps> = ({ 
  schedule, 
  onUpdateSchedule 
}) => {
  ...
  // แปลงข้อมูล schedule เป็น events สำหรับปฏิทิน
  ...
  const handleSelectSlot = (slotInfo: any) => {
    ...
    // สามารถเพิ่มการสร้าง schedule ใหม่ได้ที่นี่
  };
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-slate-800 mb-2">ปฏิทินการทำงาน</h1>
        <p className="text-slate-600">จัดการตารางการรับซื้อและขนส่งไผ่</p>
      </div>
